...
const PortfolioCard = () => {
    const projects = [
        ...
        {image: '/images/Dao/DAO.jpg', name: 'Decentralized Autonomous Organisation(DAO)', categories: 'Web3, Dapp, DAO, NFT, testnet', tech: 'Nextjs, Hardhat, Solidity, Nextui', liveViewUrl: 'https://dao-tutorial-lightpc90.vercel.app/', codeUrl: 'https://github.com/lightpc90/dao-tutorial'},
        ...
        {image: '/images/whitelist/whitelist.png', name: 'NFT Whitelist Dapp', categories: 'Web3, Dapp, NFTs, testnet', tech: 'Nextjs, Hardhat, Solidity, Nextui', liveViewUrl: 'https://whitelist-dapp-lightpc90.vercel.app/', codeUrl: 'https://github.com/lightpc90/whitelistDappNew'},
